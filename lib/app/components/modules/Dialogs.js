...
var _ExternalLinkWarning = require('./ExternalLinkWarning');

var _ExternalLinkWarning2 = _interopRequireDefault(_ExternalLinkWarning);
    ...
    (0, _createClass3.default)(Dialogs, [{
        ...
        value: function render() {
            ...
            var dialogs = active_dialogs.reduce(function (r, v, k) {
                ...
                ) : k === 'externalLinkWarning' ? _react2.default.createElement(
                    'span',
                    { key: idx++ },
                    _react2.default.createElement(
                        _Reveal2.default,
                        { onHide: _this3['hide_' + k], show: true },
                        _react2.default.createElement(_CloseButton2.default, { onClick: _this3['hide_' + k] }),
                        _react2.default.createElement(_ExternalLinkWarning2.default, (0, _extends3.default)({
                            onClick: _this3['hide_' + k]
                        }, v.get('params').toJS()))
                    )
                ) : null;
