...
var ExplorePost = (_temp = _class = function (_Component) {
    ...
    (0, _createClass3.default)(ExplorePost, [{
        ...
        value: function render() {
            ...
            var steemd = 'https://wortheum.news' + link;
            var steemdb = 'https://wortheum.news' + link;
            var busy = 'https://wortheum.news' + link;
            var steemit = 'https://wortheum.news' + link;
            var steemitmd = '[' + title + '](https://wortheum.news' + link + ')';
