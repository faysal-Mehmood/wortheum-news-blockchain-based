...
Welcome to Wortheum!  This agreement (the “Agreement”) between you and
Wortheum OÜ. (“we”, “us”, “our”) sets out your rights to access
and use of wortheum.news and any other products or services provided by us (the
...
wortheum.news. Your continued use of the Service will confirm your acceptance of
the changes.
...
the Wortheum blockchain or our licensors, which we call “Wortheum Content.”
Wortheum Content is protected by intellectual property laws, including copyright
...
rights to use Wortheum Content.

You are granted a limited, non-exclusive, non-transferable, and
non-sublicensable license to access and use the Service and Wortheum Content for
...
“Wortheum,”, the Wortheum logo and any other product or service names, logos,
slogans that may appear on the Service are trademarks of Wortheum OÜ., and,
...
look and feel of wortheum.news and the Service is protected by copyright ©
Wortheum OÜ. All rights reserved. You may not duplicate, copy, or reuse any
portion of the HTML/CSS, Javascript, or visual design elements or concepts
without express written permission.

We encourage third-party dapp developers building on top of the Wortheum
blockchain to reach out to legal@wortheum.io for all branding and licensing
questions.
...
utilizing an Internet-based Wortheum blockchain account service including, but not
...
or mistyped Wortheum blockchain addresses; (b) Server failure or data loss; (c)
...
other liability which may not otherwise be limited or excluded under Estonia's law.

## 6. Agreement to Hold Wortheum OÜ. Harmless

6.1. You agree to hold harmless Wortheum OÜ. (and each of our officers,
...
8.1. You need not use a Wortheum blockchain account provided by us, and you can
create an account independently of the Service. If you would like to use part
of the Service, you must create a Wortheum blockchain account (“Account”).
...
Service or accessing Wortheum Content, you acknowledge these inherent risks.

## 9. The Services

9.1. As described in more detail below, the Services, among other things,
provide software that facilitates the submission of Wortheum blockchain
transaction data to the Wortheum blockchain without requiring you to access the
Wortheum blockchain command line interface.
9.2. Account and Private Keys. Should you agree to create an Account through our Service, we generate a cryptographic private and public key pair that are provided solely to you and completely owned by you; provided however that we not store passwords or Private Keys for our you. We never have access to your Private Key and do not custody any Private Keys on your behalf, and therefore, assume no responsibility for the management of the Private Key tied to your Account. The Private Key uniquely match the Account name and must be used in connection with the Account to authorize the transfer of WORTH and Worth Dollars from that Account. You are solely responsible for maintaining the security of your Private Keys. You must keep your Private Key access information secure. Failure to do so may result in the loss of control of WORTH, Worth Power and Worth Dollars associated with your Account.
...
pairs maintained in your Account, you accept and acknowledge that any WORTH,
Worth Dollars and Worth Power you have associated with such Account will become
permanently inaccessible if you do not have your Account password.

9.4.  Transactions. All proposed Wortheum blockchain transactions must be
confirmed and recorded in the Wortheum blockchain via the Wortheum distributed
consensus network (a peer-to-peer network), which is not owned, controlled, or
operated by us. The Wortheum blockchain is operated by a decentralized network of
independent third parties. We have no control over the Wortheum blockchain and
therefore cannot and will not ensure that any transaction details you submit
via the Services will be confirmed on the Wortheum blockchain. You acknowledge and
agree that the transaction details you submit via the Services may not be
completed, or may be substantially delayed, by the Wortheum blockchain. You may
use the Services to submit these details to the Wortheum blockchain.

9.5.  No Storage or Transmission of WORTH, Worth Dollars or Worth Power. WORTH,
in any of its forms (WORTH, Worth Dollars and Worth Power) is an intangible,
digital asset controlled by you.  These assets exist only by virtue of the
ownership record maintained on the Wortheum blockchain. The Service does not
store, send, or receive WORTH, Worth Dollars, or Worth Power. Any transfer of
title that might occur in any WORTH, Worth Dollars or Worth Power occurs on the
Wortheum blockchain and not within the Services. We do not guarantee that the
Service can affect the transfer of title or right in any WORTH, Worth Dollars
or Worth Power.
...
make in connection with any Wortheum blockchain transaction initiated via the
...
submitted to the Wortheum blockchain via the Services, The Services cannot assist
you to cancel or otherwise modify your transaction details. We have no control
over the Wortheum blockchain and do not have the ability to facilitate any
...
determining whether taxes apply to your Wortheum blockchain transactions or for
collecting, reporting, withholding, or remitting any taxes arising from any
Wortheum blockchain transactions.
...
11.1. If you use a Service to which WORTH, Worth Dollars or Worth Power is
...
Services, you will be may not be able to access WORTH, Worth Dollars and Worth
...
wortheum.news account and all related information and files in such without cost
...
you access to the Wortheum blockchain via the command line API or third party
...
Harju maakond, Tallinn, Kesklinna linnaosa,
 Narva mnt 5, Estonia, 10117

copyright@wortheum.news
...
To the fullest extent permitted by applicable law, the Service and the Wortheum
...
the Service and the Wortheum Content: (a) will be secure or available at any
...
other harmful components. Your use of the Service and Wortheum Content is solely
...
To the fullest extent permitted by applicable law, in no event shall Wortheum OÜ. or the any related party to Wortheum OÜ., that includes but is not
...
connected with, the use of, or inability to use, the Service or the Wortheum
Content. To the fullest extent permitted by applicable law, in no event shall
the aggregate liability of Wortheum. or any related party, whether in
...
arbitrate certain disputes with Wortheum OÜ. and limits the way you can seek
relief from Wortheum OÜ. If you do not agree with this Section 20, please
...
names, logos, trade secrets or patents, you and Wortheum OÜ.: (a) waive your
right to have any and all disputes or Claims arising from this Agreement or
Wortheum OÜ. (collectively, “Disputes”) resolved in a court; and (b) waive
...
that any dispute is personal to you and Wortheum OÜ. and that any such dispute
...
of another individual or group of individuals. Further, you and Wortheum OÜ.
...
provided by sending an email to legal@wortheum.io. Your notice must include:
...
of the us receiving the notice, either you or Wortheum OÜ. may, as appropriate
...
agree that: (a) any arbitration will occur in Tallinn, Estonia; (b)
arbitration will be conducted confidentially by a single arbitrator in
accordance with the rules of JAMS; and (c) the state or federal courts in Tallinn will have exclusive jurisdiction over the enforcement of an arbitration
...
This Agreement and your access to and use of the Service and the Wortheum
Content will be governed by, and construed in accordance with, the laws of Estonia, without resort to its conflict of law provisions. To the extent the
...
and federal courts located in Estonia, and you hereby
...
your license to access and use of the Service, which includes, wortheum.news, and
...
this edition available as an archive on wortheum.news. By continuing to use the
