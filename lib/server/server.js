...
app.use((0, _koaMount2.default)('/robots.txt', /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
...
if (env !== 'test') {
    ...
    app.use( /*#__PURE__*/_regenerator2.default.mark(function _callee6() {
        var bot;
