...
export default class PdfDownload extends Component {
    ...
    downloadPdf() {
        ...
        const filename = this.props.name + '_worth_keys.pdf';
...
*/
        ...
        offset += this.renderText(
            ctx,
            'Used to log in to apps such as Wortheum.news and perform ' +
                'actions such as posting news/articles, commenting, and voting.',
            {
                scale,
                x: margin + qrSize + 0.1,
                y: offset,
        ...
        offset += this.renderText(
            ...
            'Used for monetary and wallet related actions, such as ' +
                'transferring tokens or powering WORTH up and down.',
            {
                scale,
                x: margin + qrSize + 0.1,
                y: offset,
        ...
        offset += this.renderText(
            ...
            'This key is used to reset all your other keys. It is ' +
                ...
                'within 30 days at https://wortheumwallet.com.',
            {
                scale,
                x: margin + qrSize + 0.1,
                y: offset,
        ...
        offset += this.renderText(
            ...
            'Public keys are associated with usernames and are used to ' +
                ...
                'for login. You can view these anytime at: https://worthdb.com/@' +
                this.props.name,
            {
                scale,
                x: margin,
