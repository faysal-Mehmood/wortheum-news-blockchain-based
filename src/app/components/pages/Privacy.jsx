        ...
        return (
            <div className="Privacy row">
                <div className="column large-12">
                    <h1>Wortheum OÜ Privacy Policy</h1>
                    <h2>Effective: Nov 20, 2021</h2>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                        <span>
                            This Privacy Policy describes how Wortheum collects,
                            uses and discloses information, and what choices you
                            have with respect to the information. This Policy
                            applies to the
                        </span>
                        <span>
                            &nbsp; Wortheum.news, Wortheum subdomains (e.g.,
                            signup.wortheum.news) and services
                        </span>
                        <span className="c1">
                    ...
                    <p className="c2">
                        <span className="c1">
                            When we refer to &ldquo; Wortheum&rdquo;, we mean the
                            Wortheum entity that acts as the controller of your
                            information.
                        </span>
                    </p>
                    <p className="c2">
                    ...
                    <p className="c2">
                        <span className="c1">
                            The Company has offices outside of the India and has
                    ...
                    <p className="c2">
                        <span>
                            ...
                            request to privacy@wortheum.io. You can request to
                    ...
                    <p className="c2">
                        <span className="c1">
                            ...
                            contacting us at privacy@wortheum.io
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1" />
                    ...
                    <p className="c2">
                        <span>
                            ...
                            privacy@wortheum.news. We may request specific
                            ...
                            privacy@wortheum.io or submit a complaint to the
                    ...
                    <p className="c2">
                        <span className="c1">
                            ...
                            under the header &ldquo;Notice to EU Dat
