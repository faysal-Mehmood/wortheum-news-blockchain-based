                ...
                <section className="AboutMission">
                    ...
                    <div className="AboutMission__section">
                        <div className="AboutMission__text-container">
                            ...
                            <p className="AboutMission__text">
                                Our vision is that wortheum is a vibrant
                    ...
                    <div className="AboutMission__section">
                        <div className="AboutMission__text-container">
                            ...
                            <p className="AboutMission__text">
                                ...
                                wortheum by way of advertisements and
                                programatically selling cryptocurrency assets
                                that wortheum OU holds. Wortheum, for
                                instance, has held lots of WORTH since creation. The
                                company could have sold all of it over the past
                                some time, and instead continues to hold and
                                only sell programmatically, because we value the
                                potential of Worth. Advertising is also an
                                important part of our business for aligning
                                wortheum with all its participants, such as
                                jurnalists, bloggers, content consumers, community builders
                                and our company’s shareholders, who all benefit
                                from increased stickiness and usage of
                                wortheum.news. Both of these revenue
                    ...
                    <div className="AboutMission__section AboutMission__section--vision">
                        <div className="AboutMission__text-container">
                            ...
                            <p className="AboutMission__text">
                                We strive to make wortheum great for
                            ...
                            <ul className="AboutMission__list">
                                ...
                                <ul className="AboutMission__list">
                                    ...
                                    <ul className="AboutMission__list">
                                        ...
                                        <ul className="AboutMission__list">
                                            <li className="AboutMission__list-item">
                                                Communication of Wortheum
                                                developments
                                            </li>
                                            <li className="AboutMission__list-item">
                                                Communication of wortheum.news
                                                developments
                                            </li>
                                            <li className="AboutMission__list-item">
                                                Communication of Wortheum
                                            ...
                                            <li className="AboutMission__list-item">
                                                Communication of Wortheum Dapps /
                            ...
                            <p>
                                ...
                                our Wortheum development?
                            </p>
                            <ul className="AboutMission__list">
                                <li className="AboutMission__list-item">
                                    We strive to make Wortheum great for online
                                    communities and financial inclusion. This
                                ...
                                <ul className="AboutMission__list">
                                    ...
                                    <ul className="AboutMission__list">
                                        ...
                                        <li className="AboutMission__list-item">
                                            Lower costs of running wortheum.news
                            ...
                            <p>
                                ...
                                WORTH and cryptocurrency adoption.
                            </p>
                        </div>
                        <div className="AboutMission__image-container">
                            <img
                    ...
                    <div className="AboutMission__section">
                        <div className="AboutMission__text-container">
                            ...
                            <p className="AboutMission__text">
                                WORTHEUM (The “Company”), is a private
                                company that helps develop the open-source
                                software that powers WORTHEUM.NEWS, including
                                steemd. The Company may own various digital
                                assets, including, without limitation,
                                quantities of cryptocurrencies such as WORTH.
