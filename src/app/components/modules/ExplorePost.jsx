...
class ExplorePost extends Component {
    ...
    render() {
        ...
        const steemd = 'https://wortheum.news' + link;
        const steemdb = 'https://wortheum.news' + link;
        const busy = 'https://wortheum.news' + link;
        const steemit = 'https://wortheum.news' + link;
        const steemitmd = '[' + title + '](https://wortheum.news' + link + ')';
        let text =
            ...
            <span className="ExplorePost">
                ...
                <ul>
                    <li>
                        ...
                        >
                            wortheum.news <Icon name="extlink" />
                        </a>
                    </li>
                    <li>
                        <a
